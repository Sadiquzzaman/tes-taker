...
export const QUESTION_BUILDER_GAPS = {
  blockOuter: "gap-2",
  normalCardInner: "gap-6 max-[600px]:gap-4",
  ...
  validation: "gap-1",
  headerOuter: "gap-8 max-[600px]:gap-4",
  headerContent: "gap-4 max-[600px]:gap-2",
  headerLead: "gap-2",
  headerText: "gap-3 max-[600px]:gap-2",
  headerImageActions: "gap-2",
  headerSide: "gap-2",
  bodyStack: "gap-2",
  optionRow: "gap-2",
  optionContent: "gap-3 max-[600px]:gap-2",
  optionImageActions: "gap-2",
  optionActionButtons: "gap-1",
  optionSide: "gap-2",
  addOptionRow: "gap-2",
  footerOuter: "gap-4 max-[600px]:gap-2",
  footerGroup: "gap-2 max-[600px]:gap-1",
  instruction: "gap-2 max-[600px]:gap-1",
  textAnswerStack: "gap-3",
  textAnswerInput: "gap-2",
  matchingBody: "gap-1",
  matchingAddButton: "gap-2",
  matchingRow: "gap-4 max-[600px]:gap-2",
  matchingSide: "gap-2",
} as const;
